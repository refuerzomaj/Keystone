...
export function paymentForm() {
	...
	document.getElementById( 'cls-update-payment-method' ).addEventListener( 'submit', onAuthorizePayment );
}
...
function setPaymentMethod() {
	const form = document.getElementById( 'cls-update-payment-method' );
...
async function onAuthorizePayment( e ) {
	...
	try {
		const paymentMethod = await getPaymentMethod( form, window.clStripe.cardElement );
...
export function completeAuthorization( intentId ) {
	return apiRequest( 'cls_complete_payment_authorization', {
		intent_id: intentId,
		'cls-complete-payment-authorization': document.getElementById(
...
function disableForm() {
	const submit = document.getElementById( 'cls-update-payment-method-submit' );
...
export function handleException( error ) {
	...
	const container = document.getElementById( 'cls-update-payment-method-errors' );
