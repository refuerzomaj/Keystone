<?php
/**
 * CL_Stripe_Utils_Exceptions_Attribute_Not_Found exception class
 *
 * @package CL_Stripe
 * @since   2.6.19
 */
...
/**
 * Implements an CL_Stripe_Utils_Exceptions_Attribute_Not_Found exception thrown when a given
 ...
 */
class CL_Stripe_Utils_Exceptions_Attribute_Not_Found extends OutOfBoundsException {
	 ...
	 *                                  Default null.
	 * @return CL_Stripe_Exceptions_Attribute_Not_Found Exception instance.
	 */
	public static function from_attr( $attribute_name, $collection, $code = null, $previous = null ) {
		$message = sprintf(
			'The \'%1$s\' attribute does not exist for \'%2$s\'.',
			$attribute_name,
			$collection
		);
