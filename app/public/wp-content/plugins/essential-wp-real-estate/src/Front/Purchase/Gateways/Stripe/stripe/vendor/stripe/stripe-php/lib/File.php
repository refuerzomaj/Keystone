 ...
 * @property null|string $url The URL from which the file can be listinged using your live secret API key.
 */
class File extends ApiResource
{
    ...
    const PURPOSE_IDENTITY_DOCUMENT_listingABLE = 'identity_document_listingable';
