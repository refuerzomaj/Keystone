 ...
 * @abstract
 */
abstract class CL_Stripe_Utils_Registry extends ArrayObject {
	 ...
	 *
	 * @throws Exception if the item does not exist.
	 * @throws CL_Stripe_Exceptions_Attribute_Not_Found if the attribute and/or item does not exist.
	 *
	...
	public function get_attribute( $key, $item_id ) {
		...
		if ( ! empty( $item[ $key ] ) ) {
			...
			throw CL_Stripe_Utils_Exceptions_Attribute_Not_Found::from_attr( $key, $item_id );
		}
