<?php
namespace Essential\Restate\Common\Roles;
...
class Roles {
	...
	public function add_roles() {
		add_role(
			'shop_manager',
			__( 'Shop Manager', 'essential-wp-real-estate' ),
			array(
				'read'                   => true,
				'edit_posts'             => true,
				'delete_posts'           => true,
		...
		add_role(
			'shop_accountant',
			__( 'Shop Accountant', 'essential-wp-real-estate' ),
			array(
				'read'         => true,
				'edit_posts'   => false,
				'delete_posts' => false,
		...
		add_role(
			'shop_worker',
			__( 'Shop Worker', 'essential-wp-real-estate' ),
			array(
				'read'         => true,
				'edit_posts'   => false,
				'upload_files' => true,
		...
		add_role(
			'shop_vendor',
			__( 'Shop Vendor', 'essential-wp-real-estate' ),
			array(
				'read'         => true,
				'edit_posts'   => false,
				'upload_files' => true,
