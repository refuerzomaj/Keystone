...
$min         = $cl_meta_field['min'] ?? '';
$max         = $cl_meta_field['max'] ?? '';
...
<div class="column col-<?php echo esc_attr( $columns . ' ' . $sortable ); ?>">
	<label for="cl-meta-number-input" class="cl-meta-number-input-label"><?php echo esc_html( $cl_meta_field['name'] ); ?></label>
	<?php
	if ( is_array( $meta_clone_val['meta_val'] ) ) {
		foreach ( $meta_clone_val['meta_val'] as $val ) {
			...
			<input min="<?php echo esc_attr( $min ); ?>" max="<?php echo esc_attr( $max ); ?>" placeholder="<?php echo esc_attr( $placeholder ); ?>" class="cl-meta-number-input" type="number" name="<?php echo esc_attr( $meta_clone_val['cl_name'] ); ?>" value="<?php echo esc_attr( $val ); ?>">
			<?php
		...
		?>
		<input min="<?php echo esc_attr( $min ); ?>" max="<?php echo esc_attr( $max ); ?>" placeholder="<?php echo esc_attr( $placeholder ); ?>" class="cl-meta-number-input" type="number" name="<?php echo esc_attr( $meta_clone_val['cl_name'] ); ?>" value="<?php echo esc_attr( $meta_clone_val['meta_val'] ); ?>">
		<?php
	}
