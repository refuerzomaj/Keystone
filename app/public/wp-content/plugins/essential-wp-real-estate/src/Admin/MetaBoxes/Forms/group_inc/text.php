...
<div class="column col-<?php echo esc_attr($group_columns); ?>" data-group_field_id="<?php echo esc_attr($cl_meta_group_field["id"]); ?>">
    <label for="cl-meta-text-input" class="cl-meta-text-input-label"><?php echo esc_html($cl_meta_group_field["name"]); ?></label>
    <input placeholder="<?php echo esc_attr($placeholder); ?>" class="cl-meta-text-input" type="text" name="<?php echo esc_attr($meta_group_clone_val['cl_name']); ?>" value="<?php echo esc_attr($meta_group_clone_val['group_meta_val']); ?>">
    <?php
    if (!empty($group_desc)) { ?>
