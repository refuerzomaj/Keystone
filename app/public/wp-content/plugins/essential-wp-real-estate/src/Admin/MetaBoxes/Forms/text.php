...
<div class="column col-<?php echo esc_attr( $columns . ' ' . $sortable ); ?>">
	...
	if ( is_array( $meta_clone_val['meta_val'] ) ) {
		foreach ( $meta_clone_val['meta_val'] as $val ) {
			...
			?>
			<input placeholder="<?php echo esc_attr( $placeholder ); ?>" class="cl-meta-text-input" type="text" name="<?php echo esc_attr( $meta_clone_val['cl_name'] ); ?>" value="<?php echo esc_attr( $val ); ?>">
			<?php
		...
		?>
		<input placeholder="<?php echo esc_attr( $placeholder ); ?>" class="cl-meta-text-input" type="text" name="<?php echo esc_attr( $meta_clone_val['cl_name'] ); ?>" value="<?php echo esc_attr( $meta_clone_val['meta_val'] ); ?>">
		<?php
	}
