<li class="cart_item empty"><?php echo WPERECCP()->front->cart->cl_empty_cart_message(); ?></li>
...
<?php endif; ?>
<li class="cart_item cl-cart-meta cl_total"><?php _e( 'Total:', 'essential-wp-real-estate' ); ?> <span class="cart-total"><?php echo WPERECCP()->common->formatting->cl_currency_filter( WPERECCP()->common->formatting->cl_format_amount( WPERECCP()->front->cart->get_total() ) ); ?></span></li>
