            ...
            $.estatikPopup( {
                inline_html: "<p class='es-center es-popup-text'>" + message + "</p>" +
                             "<div class='es-popup__buttons es-center'>" +
                                 ...
                                 "<button data-section-machine-name='" + section_machine_name + "' data-machine-name='" + field_machine_name + "' class='js-es-fields-builder-remove-field es-btn es-btn--secondary'>" +
                                    tr.remove  + "" +
                                 "</button>" +
                             "</div>"
            } ).open();
