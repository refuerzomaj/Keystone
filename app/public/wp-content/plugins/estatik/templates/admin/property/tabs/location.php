...
<?php if ( ! $property->is_manual_address ) : ?>
    <a href="#" class="es-manual-address <?php echo $google_api_key ? 'js-es-manual-address' : 'js-es-return-false'; ?>" data-toggle-label="<?php _e( 'Hide manual address entry', 'es' ); ?>"><?php _e( 'Add address manually', 'es' ); ?></a>
<?php else : ?>
    <a href="#" class="es-manual-address <?php echo $google_api_key ? 'js-es-manual-address' : 'js-es-return-false'; ?>" data-toggle-label="<?php _e( 'Add address manually', 'es' ); ?>"><?php _e( 'Hide manual address entry', 'es' ); ?></a>
<?php endif; ?>
