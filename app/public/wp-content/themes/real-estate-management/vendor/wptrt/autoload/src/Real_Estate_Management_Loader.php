...
class Real_Estate_Management_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function real_estate_management_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function real_estate_management_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function real_estate_management_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function real_estate_management_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->real_estate_management_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function real_estate_management_load( $class ) {
